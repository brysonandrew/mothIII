...
export const metalBorderActiveStyle = css`
  box-shadow: inset ${GLASS_RED} 0 0px 0px 4px,
    /* border */ inset ${GLASS_RED} 0 -1px 5px 4px,
    /* soft SD */ inset ${GLASS_RED} 0 -1px 0px 7px,
    /* bottom SD */ inset ${GLASS_RED} 0 2px 1px 7px;
`;
